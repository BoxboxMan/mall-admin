                    ...
                    <div className="form-wrap col-lg-12">
                        <div className="form-horizontal">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-5">
                                    <p type="text" className="form-control-static">
                                        {this.state.orderInfo.statusMsg}
                                        {
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-5">
                                    <p type="text" className="form-control-static">{this.state.orderInfo.paymentTypeMsg}</p>
                                </div>
                            </div>
                            <div className="form-group">
                                    ...
                                    <tbody>
                                        {
                                            productList.map((product, index) => {
                                                return (
                                                    <tr key={index}>
                                                        <td>
                                                            <img className="p-img" src={product.productImage} alt={product.productName}/>
                                                        </td>
