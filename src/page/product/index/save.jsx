...
const ProductSave = React.createClass({
    ...
    productAdapter(product){
        ...
        return {
            ...
            subImages           : product.subImages.toString().split(','),
    ...
    onUploadSuccess(res){
        ...
        subImages.push(conf.imgHost+res.data.uri);//res.data.uri
        this.setState({
            subImages: subImages
        });
    },
    ...
    checkProduct(product){
        ...
        if(!product.categoryId || !this.state.secondCategoryId){
            result = {
                status  : false,
                msg     : '请选择商品类别'
            }
    ...
    onSubmit(e){
        ...
        let product = {
                ...
                mainImage           : this.state.subImages.toString().split(',')[0],
